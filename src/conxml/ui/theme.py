...
BORDE = "#E2E8F0"
BORDE_FOCUS = "#2563EB"
BORDE_TARJETA = BORDE  # compat: alias histórico
BORDE_SUAVE = "#F1F5F9"

TEXTO = "#0F172A"
TEXTO_SECUNDARIO = "#475569"
TEXTO_DISABLED = "#94A3B8"
SUBTEXTO = TEXTO_SECUNDARIO  # compat: alias histórico

# Colores de Sidebar (Slate-800)
SIDEBAR_FONDO = FONDO_SIDEBAR  # compat: antes literal duplicado "#1E293B"
...
AMBAR_FONDO = "#FFFBEB"
GRIS = "#64748B"
GRIS_FONDO = FONDO  # compat: antes literal duplicado "#F8FAFC"
